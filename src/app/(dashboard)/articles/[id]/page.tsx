...
export default function EditArticlePage() {
  ...
  const onSubmit = (data: ArticleFormData) => {
    ...
    const payload = {
      ...
      // If user clears date picker, it becomes empty string. Convert to null.
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-text">Sửa bài viết</h1>
          <p className="text-sm text-text-muted">
            Cập nhật thông tin bài viết {article?.title}.
          </p>
        </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          ...
          <AppButton
            ...
            disabled={!isDirty && richContent === (article?.content ?? "")}
          >
            Lưu thay đổi
          </AppButton>
        </div>
