...
export default function CreateProjectPage() {
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      setValue(fileIdField, result.fileId);
  ...
  const otherProjects = projectsData?.items ?? [];

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-text">Thêm dự án</h1>
          <p className="text-sm text-text-muted">
            Tạo dự án mới. Bạn có thể thêm ảnh thư viện sau khi tạo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            ...
            <Card className="border border-border bg-surface shadow-sm">
              ...
              <CardContent className="space-y-4 p-5">
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-text">Tổng quan dự án</label>
                  <RichTextEditor
                    content={richContent}
            ...
            <Card className="border border-border bg-surface shadow-sm">
              ...
              <CardContent className="space-y-4 p-5">
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-text">Mô tả thách thức</label>
                  <RichTextEditor
