...
import { getCtaButtons } from "../model/document.types";
          ...
          <div>
            ...
            {heroImageUrl && onHeroImageDelete && (
              <button
                ...
                className="mt-2 flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-danger/30 bg-danger/5 p-2 text-xs font-semibold text-danger transition-all hover:bg-danger/10 hover:border-danger/50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
